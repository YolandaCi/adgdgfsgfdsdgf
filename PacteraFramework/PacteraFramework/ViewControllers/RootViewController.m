...
//  诺华1
//
//  Created by like on 14/12/31.
//  Copyright (c) 2014年 牛岳兵. All rights reserved.
//
...
- (void)layoutNavControls
{
     ...
     */
    [navImageView setImage:[UIImage imageWithContentsOfFile:[self.root_bundle pathForResource:@"PacteraFramework.framework/root_top_bg" ofType:@"png"]]];
    ...
    [backImageView setImage:[UIImage imageWithContentsOfFile:[self.root_bundle pathForResource:@"PacteraFramework.framework/b_back" ofType:@"png"]]];
